...
///
/// Cuando el JSON no se puede convertir, ASP.NET responde en inglés técnico e
/// incluye el nombre interno del tipo. Ese texto llegaría tal cual a la pantalla
/// del usuario y expone detalles de implementación.
/// </summary>
public static class ErroresEnEspanol
{
    private static readonly Dictionary<string, string> NombresDeCampo = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["valorEstimado"] = "el valor estimado",
